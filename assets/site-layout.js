  ...
  <div class="container mx-auto px-4 py-3 flex items-center justify-between gap-4">
    ...
    <div class="hidden md:flex items-center gap-8">
      ...
      <div class="flex items-center gap-4 text-sm">
        <a href="https://www.facebook.com/forgemotionsystems/" target="_blank" rel="noopener noreferrer"
           class="inline-flex items-center gap-1.5 hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400/60 rounded px-1"
  ...
  <div id="mobileMenu" class="md:hidden hidden border-t border-white/5 bg-gray-800/95 backdrop-blur">
    <nav class="container mx-auto px-4 py-3" aria-label="Mobile navigation">
      <ul class="flex flex-col gap-2">
        ...
        <li>
          <a href="https://www.facebook.com/forgemotionsystems/" target="_blank" rel="noopener noreferrer"
             class="mobile-link inline-flex items-center gap-2 rounded px-3 py-2 hover:bg-white/10 hover:text-blue-400"
             aria-label="ForgeMotion Systems Facebook">
            <svg class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path d="M22 12a10 10 0 1 0-11.63 9.87v-6.99h-2.8v-2.88h2.8V9.41c0-2.76 1.64-4.29 4.15-4.29 1.2 0 2.45.21 2.45.21v2.7h-1.38c-1.36 0-1.78.84-1.78 1.7v2.04h3.03l-.48 2.88h-2.55v6.99A10 10 0 0 0 22 12z"/>
            </svg>
